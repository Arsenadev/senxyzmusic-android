...
SenxyzMusic is a YouTube Music client for Android, forked from Metrolist (itself based on InnerTune). Written in Kotlin with Jetpack Compose, Material 3, and GPL-3.0 license.

- **Package**: `com.senzy.music`
- **Version**: 13.5.0 (versionCode 148), minSdk 26, targetSdk 36, compileSdk 37
- **Owner**: xsenzy (GitHub: `@Arsenadev`, TikTok: `@xsenafvck`, website: `senxyzmusic.biz.id`)
...
- **Theme**: Custom `SenzyTheme` in `ui/theme/Theme.kt`. Default seed color `#A78BFA` (purple). Uses MaterialKolor + Palette. Supports dynamic colors, pure black, and 19 manual palettes.
