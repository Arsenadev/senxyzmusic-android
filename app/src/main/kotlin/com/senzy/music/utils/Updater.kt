...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Arsenadev/senxyzmusic-android"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Senzy.apk" -> "universal" to "foss"
                name == "Senzy-with-Google-Cast.apk" -> "universal" to "gms"
