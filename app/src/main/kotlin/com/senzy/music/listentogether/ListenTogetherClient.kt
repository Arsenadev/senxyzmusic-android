...
package com.senzy.music.listentogether
...
import com.senzy.music.constants.ListenTogetherAutoApprovalKey
import com.senzy.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.senzy.music.constants.ListenTogetherIsHostKey
import com.senzy.music.constants.ListenTogetherRoomCodeKey
import com.senzy.music.constants.ListenTogetherServerUrlKey
import com.senzy.music.constants.ListenTogetherSessionTimestampKey
import com.senzy.music.constants.ListenTogetherSessionTokenKey
import com.senzy.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.senzy.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.senzy.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.senzy.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.senzy.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.senzy.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.senzy.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
