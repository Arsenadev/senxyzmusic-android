...
import com.senzy.music.constants.AndroidAutoSectionsOrderKey
import com.senzy.music.constants.AndroidAutoYouTubePlaylistsKey
import com.senzy.music.ui.screens.settings.AndroidAutoSection
import com.senzy.music.ui.screens.settings.deserializeSections
import com.senzy.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.senzy.innertube.pages.HomePage.Section>()
