...
val baseApplicationId = "com.senzy.music"
val applicationIdOverride = System.getenv("SENZY_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("SENZY_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("SENZY_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("SENZY_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("SENZY_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("SENZY_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 148
        versionName = "13.5.0"
        resValue("string", "app_name", appNameOverride ?: "SenxyzMusic")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "SenxyzMusic Debug")
            }
            signingConfig =
...
val extractDiscordSo = tasks.register<Copy>("extractDiscordSo") {
    ...
    val aarFile = file("libs/discord_partner_sdk.aar")
