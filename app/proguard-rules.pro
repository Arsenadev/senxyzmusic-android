...
# Since Senzy Music is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.senzy.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.senzy.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.senzy.music.utils.cipher.** { *; }
-keep class com.senzy.music.utils.potoken.** { *; }
...
-keep class com.senzy.music.models.PersistQueue { *; }
-keep class com.senzy.music.models.PersistPlayerState { *; }
-keep class com.senzy.music.models.QueueData { *; }
-keep class com.senzy.music.models.QueueType { *; }
-keep class com.senzy.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.senzy.music.cast.** { *; }
...
-keep class com.senzy.music.recognition.VibraSignature { *; }
-keepclassmembers class com.senzy.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.senzy.music.listentogether.proto.** { *; }
-keepclassmembers class com.senzy.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.senzy.shazamkit.models.** { *; }
-keepclassmembers class com.senzy.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.senzy.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.senzy.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.senzy.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
